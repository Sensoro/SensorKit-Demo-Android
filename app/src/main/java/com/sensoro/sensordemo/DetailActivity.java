...
public class DetailActivity extends Activity implements CustomPopupWindow.OnItemClickListener {
    ...
    private void testUpdate() {
        File file = new File(tempPath);
        if (file.exists() && file.isFile() && file.length() >= 61423) {
        ...
        //参数2：密码
        //参数3：监听
        mSensoroDeviceSession.startUpdate(tempPath, "", new OnDeviceUpdateObserver() {
            @Override
     ...
     * @throws IOException
     */
    private void copyAssetsToSD() throws IOException {
